...
$config['authentication'] = function () {
    ...
    return require_once  dirname(__FILE__).'/../CI.php';
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'aa';
$config['licenseKey']  = '*1?3-*1**-5**5-*5**-*2**-V*H*-K**G';
...
$config['backends'][] = array(
    ...
    'root'               => 'upload_media', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'         => 0777,
    'chmodFolders'       => 0755,
